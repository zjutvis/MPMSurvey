...
var myChart = echarts.init(document.getElementById("contain2"));
...
var schema = [
  ...
  { name: "Linear OR Nonlinear", index: 5, text: "Linear" },
...
option = {
  ...
  tooltip: {
    ...
    formatter: function (obj) {
      var value = obj.value;
      return (
        '<div style="border-bottom: 1px solid rgba(255,255,255,.1); font-size: 18px;padding-bottom: 3px;margin-bottom: 0px">' +
        "<b>" +
        schema[2].text +
        "</b>：" +
        value[2] +
